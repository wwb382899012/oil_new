<template id='component-template-stock-notice-goods'>
    <table class="table table-hover table-validate table-fixed">
        <thead>
        <tr>
            <th style="width:120px;">品名<i class="must-logo">*</i></span></th>
            <th style="width:150px; ">入库通知单数量<i class="must-logo">*</i></span></th>
            <th style="width:90px; ">单位<i class="must-logo">*</i></th>
            <th style="width:100px; ">换算比例<i class="must-logo">*</i></th>
            <th style="width:200px; ">仓库<i class="must-logo">*</i></th>
            <th style="width:200px; ">备注</span></th>
            <th style="width:80px;">
                操作
            </th>
        </tr>
        ...
        <tfoot data-bind="visible: isCanAdd">
        <tr>
            <td colspan="6"></td>
            <td><a href="javascript: void 0" class="o-btn o-btn-primary action" data-bind="click:add">新增</a></td>
        </tr>
        </tfoot>
    </table>
</template>
<template id='component-template-stock-notice-goods-item'>
    <tr data-bind="with:model">
        <td>
            <select data-live-search="true" class="form-control selectpicker show-menu-arrow" title="请选择品名"
                    data-bind="
                    optionsText: 'name',
        ...
        <td style="padding: 8px !important;">
            <input type="text" class="form-control input-sm" placeholder="数量" data-bind="value:quantity">
            <input type="text" class="form-control input-sm" placeholder="数量"
                   data-bind=" visible:unit_sub_visible,value:quantity_sub">
        </td>
        <td style="padding: 8px !important;">
            ...
            <div data-bind="visible:unit_sub_visible">
                <select class="form-control selectpicker show-menu-arrow" title="单位"
                        data-bind="
        ...
        <td>
            ...
            <select class="form-control selectpicker show-menu-arrow" title="请选择仓库"
                    ...
                    valueAllowUnset: true" data-live-search="true">
            </select>
            <!-- /ko -->
            <!-- ko if: type() == 2 -->
            <span>虚拟库</span>
        ...
        <td>
            <a href="javascript: void 0" class="o-btn o-btn-action" data-bind="click:$parent.del">删除</a>
        </td>
    </tr>
</template>
...
//			return (self.unit_sub_enable() || self.unit() != self.unit_sub());
    ...
    function Goods(option) {
        ...
        if(0 == o.quantity_sub){
            self.quantity_sub = ko.observable(o.quantity);
        }
    }
