...
//列表显示
$array = array(
  array('key' => 'contract_id,contract_code', 'type' => 'href', 'style' => 'width:140px;text-align:left', 'text' => '采购合同编号', 'href_text' => '<a id="t_{1}" title="{2}" target="_blank" href="/contract/detail/?id={1}&t=1" target="_blank">{2}</a>'),
    ...
    array('key' => 'category', 'type' => 'map_val', 'map_name' => 'contract_category_buy_type', 'style' => 'width:80px;text-align:left', 'text' => '合同类型'),
