...
$array =array(
    ...
    array('key'=>'project_type_desc','type'=>'','style'=>'width:120px;text-align:center','text'=>'项目类型'),
    array('key'=>'manager_name','type'=>'','style'=>'width:80px;text-align:center;','text'=>'项目负责人'),
    array('key'=>'checkStatus','type'=>'map_val','style'=>'width:100px;text-align:center;','text'=>'审核状态','map_name'=>'contract_check_status'),
    array('key' => 'create_name', 'type' => '', 'style' => 'width:80px;text-align:center', 'text' => '创建人'),
    array('key' => 'create_time', 'type' => '', 'style' => 'width:150px;text-align:center', 'text' => '申请时间'),
);

$style = empty($_data_[data]['rows']) ? "min-width:1050px;" : "min-width:1450px;";
