 ...
 * Describe：销项票申请审核
 */
class Check17Controller extends CheckController
{
...
//        $attr= $_REQUEST["search"];
        ...
        $this->treeCode="check17_".$checkStatus;
...
//        $attr = $_REQUEST[search];
        ...
        $this->render('/check15/index',$data);
    }
    ...
    public function actionCheck()
    {
        ...
        $this->render('/check15/check',array(
            'data'=>$data[0],
    ...
    public function actionDetail()
    {
        ...
        $this->render('/check15/detail',array(
            'data'=>$data[0],
            "invoiceDetail"=>$invoiceDetail,
            "attachments"=>$attachments,
            "plans"=>$plans,
