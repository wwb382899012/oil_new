    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-danger btn-xs" data-bind="visible:isCanDelete,click:$parent.del">删除</button>
                <button class="btn btn-warning btn-xs" data-bind="visible:isShowSaveBtn,click:save">保存</button>
                <button class="btn btn-default btn-xs" data-bind="visible:isShowEditBtn,click:edit">修改</button>
