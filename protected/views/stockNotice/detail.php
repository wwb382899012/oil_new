<section class="content">
    <?php
    include 'partial/contractInfo.php';
    if (Utility::isNotEmpty($stockNotices)) {
        foreach ($stockNotices as $key => $row) { ?>
            <div class="box">
                <div class="box-header with-border link">
                    <h3 class="box-title" style="text-align: center">
                        <b><?php echo Map::$v['stock_notice_delivery_type'][$row['type']] . '入库通知单' ?>&nbsp;&nbsp;&nbsp;&nbsp;                  <a target="_blank" href="/stockIn/detail/?id=<?php echo $row['batch_id']; ?>">
                            <span style="font-size: 16px;">NO.<span><?php echo $row['code'] ?></span>
                            </span>
                        </a>
                    ...
                    <?php
                    if ($row['status'] < StockNotice::STATUS_SUBMIT) { ?>
                ...
                <div class="box-body hide1 form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static"><a href="/partner/detail/?id=<?php echo $row->contract->partner_id ?>&t=1" target="_blank" title="<?php echo $row->contract->partner->name ?>"><?php echo $row->contract->partner->name ?></a></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php
