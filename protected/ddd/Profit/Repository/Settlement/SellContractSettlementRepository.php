...
use ddd\Profit\Domain\Model\Settlement\ISellContractSettlementRepository;

use ddd\Profit\Domain\Model\Settlement\SellContractSettlement;
use ddd\Profit\Domain\Model\Settlement\SettlementItem;



class SellContractSettlementRepository extends EntityRepository implements ISellContractSettlementRepository
{

    public function getNewEntity()
    {
        return new SellContractSettlement();
    }
