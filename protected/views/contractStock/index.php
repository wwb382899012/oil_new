...
$array = array(
	...
	array('key' => 'project_id,project_code', 'type' => 'href', 'style' => 'width:200px;text-align:center;', 'text' => '项目编号', 'href_text' => '<a target="_blank" id="t_{1}" title="{2}" href="/project/detail/?id={1}&t=1">{2}</a>'),
	array('key' => 'contract_id,contract_code', 'type' => 'href', 'style' => 'width:200px;text-align:center;', 'text' => '采购合同编号', 'href_text' => '<a target="_blank" id="t_{1}" title="{2}" href="/contract/detail/?id={1}&t=1">{2}</a>'),
