...
class CorporationProfitRepository extends EntityRepository implements ICorporationProfitRepository
{

    public function getNewEntity()
    {
        return new CorporationProfit();
    }
    ...
    {
        return $this->find('t.corporation_id=' . $corporation_id);
    }
}