<section class="content" id="content">
    ...
    <div class="form-horizontal">
        <?php $this->renderPartial("/stockOut/partial/stockOutOrderInfo", array('outOrder' => $model,'isShowBackButton'=>true));?>
    </div>
...
<?php $checkLogs = FlowService::getCheckLog($model->out_order_id, $this->businessId);?>
