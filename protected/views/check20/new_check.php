<section class="content" id="content">
    ...
    <?php
    $menus = [['text'=>'出库管理'],['text'=>'出库单审核','link'=>'/check20/?search[checkStatus]=1'], ['text' => $this->pageTitle]];
    $buttons = [];
    ...
    <div class="card-wrapper">
        <?php $this->renderPartial("/stockOut/partial/new_stockOutOrderInfoCard", array('outOrders' => [$model]));?>
