...
$array = array(
    ...
    array('key' => 'project_id,project_code', 'type' => 'href', 'style' => 'width:100px;text-align:center', 'text' => '项目编号', 'href_text'=>'<a title="{2}" target="_blank" href="/project/detail/?id={1}&t=1">{2}</a>'),
