...
<section>
    ...
    $desc_type = ConstantMap::SALE_TYPE;
    ?>
    <?php
    ...
    <div class="z-card ">
        <div class="content-title-wrap">
            <h3 class="z-card-header">
                <span data-bind="text:goods_name"></span>应收结算
                ...
                <form class="col-sm-12">
                    ...
                    <div class="settlement-divide">
                        <div class="clearfix  content-title">
                            <h3 class="pull-left">发货单编号：<span data-bind="html:url" class="text-link"></span></h3>
                        </div>
                        <div class="flex-grid form-group">
                            <div class="col field col-count-3">
                                <p class="form-cell-title">出库单数量</p>
                                <input type="text" class="form-control" data-bind="value: bill_quantity() +  unit_name()" disabled>
                            </div>
                            <div class="col field col-count-3">
    ...
    <div class="z-card">
        <div class="z-card-body">
            ...
            <div>
                应收合计：<span data-bind="moneyText:settlement.amount"></span>元
            </div>
        </div>
    </div>
