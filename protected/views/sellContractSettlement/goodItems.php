                ...
                <form class="col-sm-12">
                    <fieldset>
                        ...
                        <fieldset style="border: 1px solid; padding: 0.35em 0.625em 0.75em;margin-bottom: 15px">
                            <legend class="h4 text-primary" style="border: 0;  width: auto;">发货单编号：<span><?php echo "<a href='/deliveryOrder/detail/?id=".$bill_value['bill_id']."&t=1' target='_blank'>".$bill_value['delivery_code']."</a>";?></span></legend>
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label class="col-sm-4 control-label">出库单数量</label>
                                    <p class="form-control-static col-sm-8"><?php echo number_format($bill_value["out_quantity"]['quantity'],4); ?><?php echo Map::$v['goods_unit'][$bill_value['out_quantity']['unit']]['name'];?></p>
                                </div>
                                <div class="col-sm-4">
                        ...
                        <fieldset style="border: 1px solid; padding: 0.35em 0.625em 0.75em;margin-bottom: 15px">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <label class="col-sm-4 control-label">出库单数量</label>
                                    <p class="form-control-static col-sm-8"><?php echo number_format($value["out_quantity"]['quantity'],4); ?><?php echo Map::$v['goods_unit'][$value['out_quantity']['unit']]['name'];?></p>
                                </div>
                                <div class="col-sm-4">
                                    <label class="col-sm-4 control-label">结算数量</label>
                           ...
                           <?php } ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <p class="form-control-static col-sm-8"><?php echo $value['remark'];?></p>
                                </div>
                            </div>
                        </fieldset>
                    </fieldset>
