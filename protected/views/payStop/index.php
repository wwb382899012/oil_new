...
function checkRowEditAction($row, $self)
{
    ...
    if($row['stop_status']==PayApplicationExtra::STATUS_BACK ){
        ...
        $links[] = '<a onclick="trash('.$row["apply_id"].')" title="止付作废">作废</a>';
    }
...
$form_array = array('form_url'=>'/'.$this->getId().'/',
	'input_array'=>array(
        ...
        array('type' => 'select', 'key' => 'a.type', 'map_name' => 'pay_application_type', 'text' => '付款类型&emsp;&emsp;'),
        array('type' => 'corpName', 'key' => 'a.corporation_id', 'text' => '交易主体&emsp;&emsp;'),
        ...
        // array('type'=>'subjectName','key'=>'a.subject_id','text'=>'用途&emsp;&emsp;&emsp;&emsp;'),
        array('type' => 'select', 'key' => 'a.subject_id', 'map_name' => 'finance_subjects', 'text' => '用途&emsp;&emsp;&emsp;&emsp;'),
        ...
        array('type' => 'select', 'key' => 'e.status', 'map_name'=>'pay_stop_status', 'text' => '状态&emsp;&emsp;&emsp;&emsp;'),
        array('type' => 'text', 'key' => 'p.project_code*', 'text' => '项目编号&emsp;&emsp;'),
        array('type' => 'text', 'key' => 'su.name*', 'text' => '申请人&emsp;&emsp;&emsp;'),
    ...
    "buttonArray"=>array(
        ...
        array('text' => '付款止付', 'buttonId' => 'list'),
    ),
);

//列表显示
$array = array(
    array('key' => 'apply_id', 'type' => 'href', 'style' => 'width:120px;text-align:center;', 'text' => '操作', 'href_text' => 'checkRowEditAction'),
    array('key' => 'stop_code', 'type' => '', 'style' => 'width:120px;text-align:center', 'text' => '止付编号'),
    ...
    array('key' => 'stop_status', 'type' => 'map_val', 'map_name' => 'pay_stop_status', 'style' => 'width:100px;text-align:center', 'text' => '状态'),
    ...
    array('key' => 'contract_category', 'type' => 'map_val', 'map_name' => 'contract_category', 'style' => 'width:140px;text-align:center', 'text' => '货款合同类别'),
    ...
    array('key' => 'stop_apply_time', 'type' => '', 'style' => 'text-align:center', 'text' => '止付申请时间'),
    // array('key' => 'exchange_rate', 'type' => '', 'style' => 'text-align:center', 'text' => '汇率'),
);

$style = empty($_data_['data']['rows']) ? "min-width:1050px;" : "min-width:2400px;";
