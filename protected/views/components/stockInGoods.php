...
<template id='component-template-stock-in-goods-item'>
    <tr data-bind="with:model">
        ...
        <td>
            <input type="text" class="form-control input-sm" placeholder="入库单数量" data-bind="visible:showQuantityInput,numberFixed:quantity">
            <p data-bind="numberFixedText:quantity,visible:!showQuantityInput()"></p>
            <input type="text" class="form-control input-sm" placeholder="入库单数量" data-bind="visible:(!showQuantityInput() && showUnitRate()),numberFixed:quantity_sub">
            <p data-bind="numberFixedText:quantity_sub,visible:(showQuantityInput() && showUnitRate())"></p>
        </td>
        <td>
            <p data-bind="text:unit_desc"></p>
            <p data-bind="text:unit_sub_desc,visible:showUnitRate"></p>
        </td>
        <td>
