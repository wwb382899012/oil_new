...
<section class="content-header menu-path is-fixed-bread">
    ...
    <div class="flex-grid col">
        <button type="button" data-bind="click:submit">通过</button>
        <button type="button" data-bind="click:rollback">驳回</button>
        <button type="button" data-bind="click:back">返回</button>
    </div>
</section>
