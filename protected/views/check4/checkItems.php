    ...
    <div class="box box-primary">
        ...
        <form class="form-horizontal" role="form" id="mainForm">
            <div class="box-body">
                ...
                <!-- /ko -->
                <?php include ROOT_DIR . DIRECTORY_SEPARATOR . "protected/views/components/contractCheckItems.php"; ?>
...
<script>
    ...
    function ViewModel(option)
    {
        ...
        self.doSubmit=function(){
            ...
            layer.confirm("您确定要提交当前信息的审核，该操作不可逆？", {icon: 3, title:"提示"}, function(index){
