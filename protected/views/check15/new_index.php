...
$array =array(
    ...
    array('key'=>'type_sub','type'=>'map_val','style'=>'width:100px;text-align:left','map_name'=>$invoice_type,'text'=>'发票属性'),
    ...
    array('key'=>'contract_id,contract_code','type'=>'href','style'=>'width:130px;text-align:left','text'=>'货款合同编号','href_text'=>'<a id="t_{1}" title="{2}" target="_blank"  href="/contract/detail/?id={1}&t=1" >{2}</a>'),
