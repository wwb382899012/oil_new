<template id='component-template-contract-goods' >
    <table class="table table-hover table-hover-custom ">
        <thead>
            <tr>
              <th style="width:10%;">品名<span class="must-logo">*</span></th>
              <th style="width:10%;">计价标的<span data-bind="visible:needTarget"><span class="must-logo">*</span></span></th>
              <th style="width:9%;">溢短装比</span></th>
              <th style="width:11%;">数量<span class="must-logo">*</span> 单位<span class="must-logo">*</th>
<!--              <th style="width:9%;"></span></th>-->
              <th style="width:16%;">单位换算比<span class="must-logo">*</span></th>
              <th style="width:14%;"><span data-bind="visible:upExchange">采购</span><span data-bind="visible:!upExchange()">销售</span>单价<span class="must-logo">*</span></th>
              <th style="width:15%;"><span data-bind="visible:upExchange">采购</span><span data-bind="visible:!upExchange()">销售</span>总价</th>
              <th style="width:15%;"><span data-bind="visible:upExchange">采购</span><span data-bind="visible:!upExchange()">销售</span>人民币总价</th>
              <th style="width:7%;" data-bind="visible:$root.goods_can_edit()==1">操作</th>
            </tr>
        </thead>
...
<!--            <td >&nbsp;</td>-->
            ...
            <td >&nbsp;</td>
            <td > </td>
            <td style="vertical-align: middle;text-align:right;">合计</td>
            <td style="vertical-align: middle;color:#FF6E34;text-align:left;"><span data-bind="text:currency_ico"></span> <span data-bind="moneyText:amount"></span></td>
            <td style="vertical-align: middle;color:#FF6E34;text-align:left;">￥ <span data-bind="moneyText:amount_cny"></span></td>
            <td style="text-align: left;" data-bind="visible:$root.goods_can_edit()==1">　<a data-bind="click:add,visible:$root.goods_can_edit()==1" href="javascript: void 0" class="oil-btn" style="width:50px;min-width: unset;">新增</a></td>
        </tr>
        </tfoot>
    </table>
</template>
    ...
    <tr data-bind="with:model">
        <td>
            <select data-live-search="true" class="selectpicker show-menu-arrow form-control" title="请选择品名"  name="c[goods_id]"
                    ...
                    enable:$root.goods_can_edit()==1
                    ">
            </select>
        </td>
        <td>
            <input type="text" class="form-control input-sm" name= "c[refer_target]" placeholder="计价标的" data-bind="value:refer_target,enable:$root.goods_can_edit()==1">
        </td>
        <td>
            <div class="input-group  input-group-sm">
                <input type="text" class="form-control"  name= "c[more_or_less_rate]" placeholder="溢短装比例" data-bind="percent:more_or_less_rate,enable:$root.goods_can_edit()==1" >
...
<!--        <td></td>-->
        <td>
            <div style="padding: 5px 0;">
                <input style="margin-bottom: 5px" type="text" class="form-control input-sm" name= "c[quantity]" placeholder="数量" data-bind="value:quantity,enable:$root.goods_can_edit()==1">
        ...
        <td>
            ...
            <div class="input-group" data-bind="visible: showUnitConvert">
                ...
                <input type="text" class="form-control input-sm" name="" placeholder="" data-bind="value:unit_convert_rate,enable:$root.goods_can_edit()==1">
            </div>
        </td>
        <td>
            <div class="input-group">
                <span class="input-group-addon" data-bind="text:currency_ico"></span>
                <input type="text" class="form-control input-sm" name="c[price]" placeholder="单价" data-bind="money:price,enable:$root.goods_can_edit()==1">
            </div>
        </td>
        ...
        <td style="text-align:left;" data-bind="visible:$root.goods_can_edit()==1"><a href="javascript: void 0" class="z-btn-action" data-bind="click:$parent.del,visible:$root.goods_can_edit()==1">删除</a></td>
    </tr>
</template>
...
<script>
    ...
    ko.components.register('new_contract-goods', {
    ...
    function contractGoodsComponent(params)
    {
        ...
        // self.goods_can_edit=params.goods_can_edit;
