...
return [
    ...
    ['class' => 'ddd\Profit\Domain\Model\Invoice\IInvoiceRepository', 'definition' => 'ddd\Profit\Repository\Invoice\InvoiceRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Model\Payment\IProjectPaymentRepository', 'definition' => 'ddd\Profit\Repository\Payment\ProjectPaymentRepository', 'params' =>[], 'singleton' =>1],
    //预估利润报表
    ['class' => 'ddd\Profit\Domain\EstimateProfit\IEstimateContractProfitRepository', 'definition' => 'ddd\Profit\Repository\EstimateProfit\EstimateContractProfitRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\EstimateProfit\IEstimateProjectProfitRepository', 'definition' => 'ddd\Profit\Repository\EstimateProfit\EstimateProjectProfitRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\EstimateProfit\IEstimateCorporationProfitRepository', 'definition' => 'ddd\Profit\Repository\EstimateProfit\EstimateCorporationProfitRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Event\IEventRepository', 'definition' => 'ddd\Profit\Repository\Event\EventRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Quantity\ISellOutQuantityRepository', 'definition' => 'ddd\Profit\Repository\Quantity\SellOutQuantityRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\Model\Settlement\ILadingBillSettlementRepository', 'definition' => 'ddd\Profit\Repository\Settlement\LadingBillSettlementRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\Model\Settlement\IDeliveryOrderSettlementRepository', 'definition' => 'ddd\Profit\Repository\Settlement\DeliveryOrderSettlementRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\Model\Settlement\IBuyContractSettlementRepository', 'definition' => 'ddd\Profit\Repository\Settlement\BuyContractSettlementRepository', 'params' =>[], 'singleton' =>1],
	['class' => 'ddd\Profit\Domain\Model\Settlement\ISellContractSettlementRepository', 'definition' => 'ddd\Profit\Repository\Settlement\SellContractSettlementRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Price\ISellPriceRepository', 'definition' => 'ddd\Profit\Repository\Price\SellPriceRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Price\ISellSettledPriceRepository', 'definition' => 'ddd\Profit\Repository\Price\SellSettledPriceRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Price\IBuyPriceRepository', 'definition' => 'ddd\Profit\Repository\Price\BuyPriceRepository', 'params' =>[], 'singleton' =>1],
    ['class' => 'ddd\Profit\Domain\Price\IBuySettledPriceRepository', 'definition' => 'ddd\Profit\Repository\Price\BuySettledPriceRepository', 'params' =>[], 'singleton' =>1],
];