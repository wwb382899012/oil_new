...
$form_array = array(
    ...
    'input_array'=>array(
        ...
        array('type'=>'text','key'=>'b.payee*','text'=>'收款单位&emsp;&emsp;'),
...
$array =array(
    ...
    array('key'=>'check_id','type'=>'','style'=>'width:60px;text-align:center','text'=>'审核编号'),
    array('key' => 'apply_id,stop_code', 'type' => 'href', 'style' => 'width:100px;text-align:center', 'text' => '止付编号', 'href_text'=>'<a id="t_{1}" title="{2}" target="_blank" href="/payStop/detail/?t=1&id={1}">{2}</a>'),
    array('key' => 'apply_id,apply_id', 'type' => 'href', 'style' => 'width:100px;text-align:center', 'text' => '付款申请编号', 'href_text'=>'<a id="t_{1}" title="{2}" target="_blank" href="/pay/detail/?t=1&id={1}">{1}</a>'),
    ...
    array('key' => 'corporation_id,corp_name', 'type' => 'href', 'style' => 'width:140px;text-align:center', 'text' => '交易主体', 'href_text' => '<a target="_blank" id="t_{1}" title="{2}" href="/corporation/detail/?id={1}&t=1">{2}</a>'),
     array('key' => 'type', 'type' => 'map_val', 'map_name' => 'pay_application_type', 'style' => 'width:100px;text-align:center', 'text' => '付款类型'),
    array('key' => 'payee', 'type' => '', 'style' => 'width:140px;text-align:center', 'text' => '收款单位'),
