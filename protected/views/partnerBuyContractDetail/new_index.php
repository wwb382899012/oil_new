...
$array = array(
	...
	array('key' => 'contract_id,contract_code', 'type' => 'href', 'style' => 'width:140px;text-align:left', 'text' => '合同编号', 'href_text' => '<a id="t_{1}" title="{2}" target="_blank" href="/contract/detail/?id={1}&t=1" target="_blank">{2}</a>'),
	...
	array('key' => 'settle_quantity', 'type' => 'href','style' => 'width:100px;text-align:left;', 'text' => '已结算数量','href_text'=>'getSettleQuantity','params'=>'settle_quantity'),
	array('key' => 'settle_amount', 'type' => 'href', 'style' => 'width:140px;text-align:right;', 'text' => '已结算人民币金额（货款）','href_text'=>'getSettleAmount','params'=>'settle_amount'),
