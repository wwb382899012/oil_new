<template id='component-template-invoice' >
    <table class="table">
        <thead>
        <tr>
            <th style="width:230px; text-align: left;"><span data-bind="visible:isDisplayGoods">品名</span><span data-bind="visible:!isDisplayGoods()">费用名称</span> <span class="must-fill"></span></th>
            <th style="width:200px; text-align: left;" data-bind="visible:isDisplayGoods">数量 <span class="must-fill"></span></th>
            <!-- <th style="width:120px; text-align: left;" data-bind="visible:isDisplayGoods">单位 <span class="text-red fa fa-asterisk"></span></th> -->
            <th style="width:250px; text-align: left;">实际开票金额 <span class="must-fill"></span></th>
            <th style="width:180px; text-align: left;">开票日期 <span class="must-fill"></span></th>
...
<template id='component-template-invoice-item' >
    <tr data-bind="with:model">
        <td data-bind="visible:isDisplay">
            <select data-live-search="true" class="form-control input-sm" title="请选择品名"  name="c[goods_id]"
                    data-bind="
                    optionsText: 'name',
        ...
        <td><a href="javascript: void 0" class="z-btn-action" data-bind="click:$parent.del">删除</a></td>
    </tr>
</template>
