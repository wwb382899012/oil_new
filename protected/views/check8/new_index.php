...
//列表显示
$array = array(
    array('key' => 'batch_id,code', 'type' => 'href', 'style' => 'width:180px;text-align:left', 'text' => '入库通知单', 'href_text' => '<a id="t_{1}" title="{2}" href="/stockIn/detail/?id={1}&t=1" target="_blank">{2}</a>'),
    array('key' => 'settle_date', 'type' => 'text', 'style' => 'width:80px;text-align:left', 'text' => '结算日期'),
    array('key' => 'contract_id,contract_code', 'type' => 'href', 'style' => 'width:180px;text-align:left', 'text' => '采购合同编号', 'href_text' => '<a id="t_{1}" target="_blank" title="{2}" href="/contract/detail/?id={1}&t=1">{2}</a>'),
    array('key' => 'code_out', 'type'=> '', 'style' => 'width:180px;text-align:left', 'text' => '外部合同编号'),
    array('key' => 'project_id,project_code', 'type' => 'href', 'style' => 'width:180px;text-align:left', 'text' => '项目编号', 'href_text' => '<a id="t_{1}" title="{2}" href="/project/detail/?id={1}&t=1" target="_blank">{2}</a>'),
    array('key' => 'partner_id,partner_name', 'type' => 'href', 'style' => 'width:200px;text-align:left', 'text' => '上游合作方', 'href_text' => '<a id="t_{1}" title="{2}" href="/partner/detail/?id={1}&t=1" target="_blank">{2}</a>'),
    array('key' => 'corporation_id,corporation_name', 'type' => 'href', 'style' => 'width:200px;text-align:left', 'text' => '交易主体', 'href_text' => '<a id="t_{1}" title="{2}" href="/corporation/detail/?id={1}&t=1" target="_blank">{2}</a>'),
