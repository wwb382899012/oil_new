<template id='component-template-project-goods'>
    <table class="table table-hover table-hover-custom">
        <thead>
          <tr>
            <th style="width:180px;"><span class="red-star">* </span>品名
              <span class="text-red fa fa-asterisk"></span>
            </th>
            <th style="width:100px; "><span class="red-star">* </span>数量
              <span class="text-red fa fa-asterisk"></span>
            </th>
            <th style="width:100px;"><span class="red-star">* </span>单位
              <span class="text-red fa fa-asterisk"></span>
            </th>

		    <th style="width:100px;"><span class="red-star">* </span>单位换算比
				  <span class="text-red fa fa-asterisk"></span>
		    </th>

            <!-- ko if: isShowPurchasePrice -->
            <th style="width:140px; "><span class="red-star">* </span>采购单价
              <span class="text-red fa fa-asterisk"></span>
            </th>
            <!-- /ko -->
            <!-- ko if: isShowSalePrice -->
            <th style="width:140px;"><span class="red-star">* </span>销售单价
              <span class="text-red fa fa-asterisk"></span>
            </th>
            <!-- /ko -->
            <!-- ko if: isShowPurchasePrice -->
...
<template id='component-template-project-goods-item'>
    <tr data-bind="with:model">
        ...
        <td>
          <input type="text" class="form-control input-sm" name="" placeholder="数量" data-bind="value:quantity" title="请输入一个大于0的数字且小于10^15的数字"
            data-orig-title="">
        ...
        <td>
          ...
          <input type="text" class="form-control input-sm" name="" placeholder="￥ 0.00" data-bind="money:purchase_price" title="请输入一个大于0的数字且小于10^15的数字"
            data-orig-title="">
        	</span> -->
          <span class="validationMessage" style="display: none;"></span>
        </td>
        ...
        <td>
          ...
          <!-- <input type="text" class="form-control input-sm" name="" placeholder="￥ 0.00" data-bind="money:sale_price" title="请输入一个大于0的数字且小于10^15的数字"
            data-orig-title="">
          <span class="validationMessage" style="display: none;"></span> -->
        </td>
        <!-- /ko -->
        ...
        <td>
        	<div class="input-group">
                <span class="input-group-addon" data-bind="text:purchase_currency_ico"></span>
                <input readonly type="text" class="form-control input-sm" name="" placeholder="采购总价" data-bind="money:purchase_amount">
            </div>
        	<!-- <span class="form-control input-sm">
	        	<span data-bind="text:purchase_currency_ico"></span>
        ...
        <td>
        	<div class="input-group">
                <span class="input-group-addon" data-bind="text:sell_currency_ico"></span>
                <input readonly type="text" class="form-control input-sm" name="" placeholder="销售总价" data-bind="money:sale_amount">
            </div>
        	<!-- <span class="form-control input-sm">
	        	<span data-bind="text:sell_currency_ico"></span>
	    		<span   data-bind="moneyText:sale_amount"></span>
    		</span> -->
          <!-- <input readonly type="text" class="form-control input-sm" name="" placeholder="￥ 0.00" data-bind="value:sale_amount" title="请输入一个大于0的数字且小于10^15的数字"
            data-orig-title=""> -->
          <span class="validationMessage" style="display: none;"></span>
        </td>
        <!-- /ko -->
