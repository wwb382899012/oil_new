...
class ProjectProfitRepository extends EntityRepository implements IProjectProfitRepository
{

    public function getNewEntity()
    {
        return new ProjectProfit();
    }
    ...
    {
        //项目利润 持久化
        $model = $this->model()->with($this->with)->find('t.project_id='.$entity->project_id);
    ...
    {
        return $this->find('t.project_id=' . $project_id);
    }
