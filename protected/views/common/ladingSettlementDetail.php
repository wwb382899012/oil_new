                    ...
                    <form class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <p class="form-control-static col-sm-8"><?php echo $ladingSettlement["settle_date"]; ?></p>
                            </div>
                        </div>
                        <?php
                        if(!empty($ladingSettlement['settlementGoods'])) {
                            foreach ($ladingSettlement['settlementGoods'] as $k => $v) { ?>
                                <fieldset style="border: 1px solid; padding: 0.35em 0.625em 0.75em;margin-bottom: 15px">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <p class="form-control-static col-sm-8">
                                                <?php echo number_format($v['in_quantity']['quantity'], 4); ?><?php echo Map::$v['goods_unit'][$v['in_quantity']['unit']]['name']; ?>
                                                <?php
                                                if(!empty($v['out_quantity_sub']['unit']) && ($v['in_quantity']['unit']!=$v['in_quantity_sub']['unit'])){
                                                    echo "/".number_format($v['in_quantity_sub']['quantity'], 4).Map::$v['goods_unit'][$v['in_quantity_sub']['unit']]['name'];
                                                } ?>
                                            </p>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <p class="form-control-static col-sm-8"><?php echo $ladingSettlement['settle_currency']['ico'] . number_format($v['price']/100, 2); ?></p>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="col-sm-4 control-label">结算金额</label>
                                            <p class="form-control-static col-sm-8"><?php echo $ladingSettlement['settle_currency']['ico'] . number_format($v['amount']/100, 2); ?></p>
                                        </div>
                                        <?php if($ladingSettlement['settle_currency']['id']!=1){ ?><div class="col-sm-4">
                                            <label class="col-sm-4 control-label">结算汇率</label>
                                            <p class="form-control-static col-sm-8"><?php echo $v['unit_rate']; ?></p></div>
                                        <?php } ?>
                                    </div><?php if($ladingSettlement['settle_currency']['id']!=1){ ?>
                                        <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                if(!empty($v['goodsOtherFiles'])){
                                                    foreach ($v['goodsOtherFiles'] as $of){
                                                        echo '<p class="form-control-static col-sm-offset-4"><a href="/stockBatchSettlement/getFile/?id='.$of['id'].'&fileName='.$of['name'].'" target="_blank" class="btn btn-primary btn-xs">'.$of['name'].'</a></p>';
                                                    }
                                                }else{
                                                    echo '<p class="form-control-static col-sm-8">无</p>';
                                                }?>
                ...
                <div class="form-group">
                    <div class="pull-right">
                        <?php if(!empty($isCanEdit)){ ?>
                            <button type="button" class="btn btn-success" onclick="edit(<?php echo $ladingSettlement['batch_id']?>)">修改</button>
                            <?php if(!empty($isCanSubmit)){?>
                                <button type="button" class="btn btn-danger" onclick="submit(<?php echo $ladingSettlement['batch_id']?>)">提交</button>
                            <?php } ?>
                        <?php } ?>
