    ...
    <div class="z-card ">
        <div class="content-title-wrap">
            <h3 class="z-card-header"><span><?php echo $value['goods_name'];?></span>应付结算
            ...
            <div class="busi-detail">
                ...
                <div class="settlement-divide">
                    <div class="clearfix  content-title">
                        <h3 class="pull-left">入库通知单编号：<a class="text-link" href="/stockIn/detail?id=<?php echo $bill_value['batch_id'];?>&t=1" target="_blank"><?php echo $bill_value['batch_code'];?></a></h3>
                    </div>
                    <div class="flex-grid form-group">
                        <label class="col field col-count-3 flex-grid">
                            <p class="form-cell-title w-fixed">入库单数量:</p>
