...
$array = array(
    ...
    array('key' => 'project_id', 'type' => '', 'style' => 'width:100px;text-align:center', 'text' => '项目ID'),
    array('key' => 'project_id,project_code', 'type' => 'href', 'style' => 'width:120px;text-align:center', 'text' => '项目编号', 'href_text'=>'<a target="_blank" id="t_{1}" title="项目详情" href="/project/detail/?id={1}&t=1" >{2}</a>'),
    ...
    array('key' => 'type', 'type' => 'href', 'style' => 'width:140px;text-align:center', 'text' => '项目类型', 'href_text' => 'showProjectTypeDesc'),
    array('key' => 'name', 'type' => '', 'style' => 'width:80px;text-align:center', 'text' => '项目负责人'),
    array('key' => 'create_name', 'type' => '', 'style' => 'width:80px;text-align:center', 'text' => '创建人'),
    array('key' => 'create_time', 'type' => '', 'style' => 'width:120px;text-align:center', 'text' => '申请时间'),
);

$this->loadForm($form_array, $_data_);
$this->show_table($array, $_data_[data], "", "min-width:1450px;", "table-bordered table-layout", '', true);
?>
