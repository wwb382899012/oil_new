                ...
                <form class="col-sm-12">
                    <fieldset>
                        ...
                        <fieldset style="border: 1px solid; padding: 0.35em 0.625em 0.75em;margin-bottom: 15px">
                            <legend class="h4 text-primary" style="border: 0;  width: auto;">入库通知单编号：<span data-bind="html:url"></span></legend>
                        ...
                        <fieldset style="border: 1px solid; padding: 0.35em 0.625em 0.75em;margin-bottom: 15px">
                            ...
                            <?php
                            include ROOT_DIR . DIRECTORY_SEPARATOR . "protected/views/components/goodsSettlementDetail.php";
                            ?>
                        </fieldset>
                    </fieldset>
                </form>
